...
/// Reference map gets populated in order of build
/// Take the Current column, walk down each branch to its lowest widget
/// buildUp and store in buildMap, then build it
/// build up and place it in the next parents build map
///
/// What information can our metaTreeItems have in order to easily do this?
